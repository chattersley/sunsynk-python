...
from sunsynk_api_client import models
from sunsynk_api_client.types import OptionalNullable, UNSET
from typing import Callable, Dict, List, Optional, Tuple, Union


SERVERS = [
    "https://pv.inteless.com",
    # Region 1 - Production server
    "https://api.sunsynk.net",
    # Region 2 - Alternative server
    "https://{base_url}",
    # Custom server
]
