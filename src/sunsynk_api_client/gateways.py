...
class Gateways(BaseSDK):
    ...
    def get_gateways(
        ...
        *,
        ...
        upload_cycle: Optional[str] = "-1",
        soft_ver: Optional[str] = None,
        hard_ver: Optional[str] = None,
        inv_sn: Optional[str] = None,
        protocol: Optional[str] = "-1",
        agent_company_id: Optional[str] = "-1",
        lan: Optional[str] = "en",
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
        timeout_ms: Optional[int] = None,
        http_headers: Optional[Mapping[str, str]] = None,
    ) -> models.GatewaysResponse:
        r"""Get gateways
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return unmarshal_json_response(models.GatewaysResponse, http_res)
